...
vim.keymap.set('n', '<leader>fc', function() Snacks.dashboard.pick('files', {cwd = vim.fn.stdpath('config')}) end, {desc = 'open config files'})
vim.keymap.set('n', '<leader>fo', function() Snacks.dashboard.pick('oldfiles') end, {desc = 'open old files'})
vim.keymap.set('n', '<leader>ff', function() Snacks.dashboard.pick('live_grep') end, {desc = 'find file'})
vim.keymap.set('n', '<leader>fn', function() vim.cmd 'silent! ene |startinsert' end, {desc = 'open new file'})
